...
module.exports.inserttransactiondetails = (req, res, next) => {
   ...
   return new Promise((resolve, reject) => {
      ...
      db.query('select ' + clientschema + '.insert_transaction_details($1::text,$2::int,$3::text,$4::text,$5::text,$6::numeric,$7::numeric,$8::int,$9::numeric,$10::int,$11::int,$12::text,$13::text,$14::text,$15::text,$16::int,$17::text,$18::text,$19::text,$20::text,$21::numeric,$22::jsonb)', [p_transactiontype, p_transactionid, p_transactiondate, p_customername, p_mobileno, p_totalcost, p_totalsale, p_overalldiscount, p_roundoff, p_totalpayable, p_currencyid, p_gsttran, p_status, p_isactive, p_loginuser, p_linktransactionid, p_discounttype, p_replacesimilir, p_creditnoteno, p_paymentmode, p_paymentdue, saleValue], (err, result) => {
         if (err) {
